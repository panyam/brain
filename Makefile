...
SKILLS := stack-integrate.md stack-update.md stack-catalog-refresh.md stack-audit.md stack-constraints-check.md stack-constraints-overview.md stack-constraints-add.md stack-constraints-promote.md stack-migrate-frontend.md checkpoint.md design-rebuild-go.md design-drift-check.md design-map.md
