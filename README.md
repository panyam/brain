...
Coordination layer for a personal development stack. Manages component discovery, version tracking, DAG-aware updates, architectural constraint enforcement, and Claude Code configuration across 16+ reusable libraries and 18+ projects.
...
All commands output JSON (except migrations which outputs markdown).
...
```
~/newstack/brain/
├── CLAUDE.md                  ← Rules: discovery, versioning, constraints, updates
